...
{
    private static readonly Color WarmCream = new Color(1f, 0.96f, 0.88f, 1f);
    private static readonly Color LightBlueBackground = new Color(0.714f, 0.843f, 1f, 1f);
    private static readonly Color CreamBackground = new Color(1f, 0.973f, 0.863f, 1f);
    private static readonly Color PurpleCard = new Color(0.8f, 0.6f, 0.8f, 1f);
    private static readonly Color OverlayDark = new Color(0f, 0f, 0f, 0.6f);
    private static readonly Color DarkBrown = new Color(0.35f, 0.22f, 0.1f, 1f);
    ...
    private static void BuildMainMenuScene()
    {
        ...
        // === Title ===
        CreateText(canvas.transform, "TitleText", "KITTY QUEST", 48, DarkBrown,
            new Vector2(0, 300), new Vector2(600, 70));
        CreateText(canvas.transform, "SubtitleText", "JAPANESE SWEET ADVENTURE", 22, DarkBrown,
            new Vector2(0, 250), new Vector2(600, 35));

        // === Main Buttons ===
        var continueBtn = CreateButton(canvas.transform, "ContinueButton", "CONTINUE",
            new Vector2(0, -50), new Vector2(350, 60));

        var startNewBtn = CreateButton(canvas.transform, "StartNewGameButton", "START NEW GAME",
            new Vector2(0, -130), new Vector2(350, 60));

        // === Bottom-Right Text Buttons ===
        var settingsBtn = CreateButton(canvas.transform, "SettingsButton", "SETTINGS",
            new Vector2(350, -480), new Vector2(140, 40));

        var exitBtn = CreateButton(canvas.transform, "ExitButton", "EXIT GAME",
            new Vector2(500, -480), new Vector2(140, 40));
        ...
        var singleBtn = CreateButton(newGamePanel.transform, "SinglePlayerButton", "單人模式",
            new Vector2(-120, 90), new Vector2(200, 50));
        var twoBtn = CreateButton(newGamePanel.transform, "TwoPlayerButton", "雙人模式",
            new Vector2(120, 90), new Vector2(200, 50));
        ...
        var confirmBtn = CreateButton(newGamePanel.transform, "ConfirmStartButton", "開始冒險！",
            new Vector2(0, -130), new Vector2(250, 55));
        var cancelBtn = CreateButton(newGamePanel.transform, "CancelNewGameButton", "取消",
        ...
        var closeSettingsBtn = CreateButton(settingsContent.transform, "CloseSettingsButton", "關閉",
            new Vector2(0, -80), new Vector2(180, 50));
